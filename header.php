 ...
 * @since pulse 1.0.0
 */
$pulse_layout_settings = get_option( 'pulse_layout' );
switch( $pulse_layout_settings['menu_layout']['type'] ) {
  case 'mega':
    $pulse_nav_body_class = 'mega-top';
    break;
  case 'side_slide':
    $pulse_nav_body_class = 'side-slide-top';
    break;
  case 'default_sm':
  default:
    $pulse_nav_body_class = '';
}
...
<body itemscope="itemscope" itemtype="http://schema.org/WebSite" <?php body_class( $pulse_nav_body_class ); ?>>
	<div id="page"<?php if( !empty( $hero_video ) ) echo ' class="relative"'; ?>>
		<!-- Start Top Bar -->
		<header id="masthead" class="site-header" role="banner" itemscope="itemscope" itemtype="http://schema.org/WPHeader">
      <?php 
        if( is_cart() || is_checkout() || is_account_page() ) $pulse_layout_settings['menu_layout']['type'] = 'minimal';
        switch( $pulse_layout_settings['menu_layout']['type'] ) :
          case 'minimal':
      ?>
			<div id="mastInsert" class="grid-x white header-bg">
				...
				<div class="cell shrink">
					<div id="site-logo-bar" class="grid-x collapse">
						<a class="pulse-logo main-logo title-logos current-site cell shrink has-tip" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_site_url(); ?>/wp-content/themes/pulse-press/assets/tiny-logos/logo-pulse-no-circle-pink.png" alt="<?php bloginfo( 'name' ); ?> Official Logo" /><span class="show-for-sr"><?php bloginfo( 'name' ); ?> Official Site</span></a>
            <a class="secondary-logo title-logos cell shrink has-tip"  href="https://opengympremier.com/" target="_blank"><img src="<?php echo get_site_url(); ?>/wp-content/themes/pulse-press/assets/tiny-logos/OGP-Logo-Black.png" alt="Open Gym Premier Official Logo" /><span class="show-for-sr">Elite Basketball Circuit Official Site</span></a>
<!-- 						<a class="secondary-logo title-logos cell shrink has-tip"  href="http://elitebasketballcircuit.com" target="_blank"><img src="<?php echo get_site_url(); ?>/wp-content/themes/pulse-press/assets/tiny-logos/ebc-black.png" alt="Elite Basketball Circuit Official Logo" /><span class="show-for-sr">Elite Basketball Circuit Official Site</span></a>
						<a class="secondary-logo g365-logo title-logos cell shrink has-tip"  href="https://grassroots365.com" target="_blank"><img src="<?php echo get_site_url(); ?>/wp-content/themes/pulse-press/assets/tiny-logos/g365-black.png" alt="Open Gym Premier Official Logo" /><span class="show-for-sr">Grassroots 365 Official Site</span></a>
            <a class="secondary-logo g365-logo title-logos cell shrink has-tip" href="https://sportsboardroom.com/" target="_blank"><img src="/wp-content/themes/pulse-press/assets/tiny-logos/sports-boardroom.png" alt="Sports Boardroom Official Logo" /><span class="show-for-sr">Sports Boardroom Official Site</span></a> -->
					</div>
					<!--description-->
					<h3 itemprop="description" class="show-for-sr"><?php echo get_bloginfo( 'description' )?></h3>
					<!--skip to content-->
					<div class="show-on-focus skip-link"><a href="#content" title="Skip to content"><?php _e( 'Skip to content', 'pulse-press' ) ?></a></div>
				</div>
...
<!--       this one -->
      <div id="mastInsert" class="grid-x">
				...
				<div class="cell small-6 medium-7 header-bg">
					<div id="site-logo-bar" class="grid-x collapse">
<!--              data-tooltip and title for pulse main logo description for title strictly to use for line beneath this one   data-tooltip aria-haspopup="true"     title="The hub of Southern California volleyball. Camps, Club Teams, and Training for serious players."  -->
						<a class="pulse-logo main-logo title-logos current-site cell shrink has-tip" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_site_url(); ?>/wp-content/themes/pulse-press/assets/tiny-logos/logo-pulse-no-circle-pink.png" alt="<?php bloginfo( 'name' ); ?> Official Logo" /><span class="show-for-sr"><?php bloginfo( 'name' ); ?> Official Site</span></a>
            ...
            <a class="secondary-logo g365-logo title-logos cell shrink has-tip" href="https://sportsboardroom.com/" target="_blank"><img src="/wp-content/themes/pulse-press/assets/tiny-logos/sports-boardroom.png" alt="Sports Boardroom Official Logo" /><span class="show-for-sr">Sports Boardroom Official Site</span></a> -->
				...
				<nav id="site-header-menu" class="site-header-menu cell small-6 medium-5 header-bg" role="navigation" aria-label="Partners and Title Navigation">
					...
					<div id="main-nav-drawer" class="nav-drawer" style="display: none;" data-toggler data-closable="slide-out-left" data-animate="slide-in-left">
						...
						<a class="main-logo-menu main-logo pulse-logo show-for-small-only" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_site_url(); ?>/wp-content/themes/pulse-press/assets/tiny-logos/logo-pulse-no-circle-pink.png" alt="<?php bloginfo( 'name' ); ?>" /><span class="show-for-sr"><?php bloginfo( 'name' ); ?></span></a>
						<?php pulse_single_main_nav(); ?>
					</div>
...
//           echo '<h1>' . get_the_archive_title( $post->ID ) . '</h1>';
          switch( get_the_archive_title( $post->ID ) ){
            case 'Archives: Careers at pulse':
      ...
      if( !is_front_page() || $pulse_layout_settings['front_layout']['type'] !== 'tiles' ) echo '<div class="grid-container">';
    ?>