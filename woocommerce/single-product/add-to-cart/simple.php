    ...
    if(is_user_logged_in()){
		...
		<div class="input-group max-button no-margin">
			...
			<div class="input-group-button">
				<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="single_add_to_cart_button button expanded alt"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
			</div>
		</div>
